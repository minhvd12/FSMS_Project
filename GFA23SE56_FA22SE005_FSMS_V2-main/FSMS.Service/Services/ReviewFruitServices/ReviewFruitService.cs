    ...
    public class ReviewFruitService : IReviewFruitService
    {
        ...
        public async Task UpdateReviewFruitAsync(int key, UpdateReviewFruit updateReviewFruit)
        {
            try
            {
                ...
                {
                    existedReviewFruit.ReviewImageUrl = "";
                }
                else if (updateReviewFruit.UploadFile != null) existedReviewFruit.ReviewImageUrl = await _fileService.UploadFile(updateReviewFruit.UploadFile);
