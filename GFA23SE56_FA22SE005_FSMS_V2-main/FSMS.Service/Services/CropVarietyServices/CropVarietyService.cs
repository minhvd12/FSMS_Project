    ...
    public class CropVarietyService : ICropVarietyService
    {
        ...
        public async Task UpdateCropVarietyAsync(int key, UpdateCropVariety updateCropVariety)
        {
            try
            {
                ...
                /*  if (!string.IsNullOrEmpty(updateCropVariety.Image))
                  {
                      existedCropVariety.Image = updateCropVariety.Image;
                  }*/
                if (updateCropVariety.UploadFile == null)
                {
                    existedCropVariety.Image = "";
                }
                else if (updateCropVariety.UploadFile != null) existedCropVariety.Image = await _fileService.UploadFile(updateCropVariety.UploadFile);
